...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        leading: IconButton(splashColor: Colors.transparent,icon: Icon(AppIcons.drawer,color: Colors.black87,size: 16), onPressed: () {  },),
        actions: [
          Badge(
            elevation: 0,
                          ...
                          child: Container(
                            ...
                            child:Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Space(height:8),
                                  Center(child: SizedBox(height:120,width:100,child: Image.network("https://i.pinimg.com/originals/5d/ff/fc/5dfffc72a434a57037433570ec391dc1.png"))),
                                  Space(height: 8),
                                  Text("Product name",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 12),),
                                  Text("Description",style: TextStyle(fontWeight: FontWeight.w400,fontSize: 10,color: Colors.grey.shade400),
                                  ),
                                  Space(height:6),
                                  Row(
                                    ...
                                    children: [
                                      Column(
                                        children: [
                                            ...
                                            children: [
                                              ...
                                              Column(
                                                children: [
                                                  Row(
                                                    children: [
                                                      Text("\u{20B9}",style: TextStyle(fontFamily: "",fontSize: 11,color: Colors.grey.shade700),),
                                                      Text("250.00",style: TextStyle(fontFamily: "Poppins",fontWeight: FontWeight.w400,color: Colors.grey.shade700,fontSize: 11),)
                                                    ],
                                                  ),
                                                ],
                                              ),
                                          ...
                                          Row(
                                            children: [
                                              Text("\u{20B9}",style: TextStyle(fontFamily: "",fontSize: 12,color: Colors.black87),),
                                              Text("250.00",style: TextStyle(fontFamily: "Poppins",color: Colors.black87,fontSize: 12,fontWeight: FontWeight.w600),)
                                            ],
                                          ),
                                        ],
                                      ),
